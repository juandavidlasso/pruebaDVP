...
const RegisterPage = () => {
    const { errors, register, onSubmit } = useRegister()
    return (
            ...
            <Card className="w-112.5 bg-white rounded-2xl! p-0 min-h-[60vh] flex flex-col justify-between pb-3 max-lg:w-[90%]">
                ...
                <form onSubmit={onSubmit}>
                    <CardContent className="flex flex-col gap-8 items-center px-8!">
                        ...
                        <Box className="w-full">
                            <Button type="submit" variant="contained" fullWidth className="bg-black! hover:bg-[#7D2D6F]! normal-case! text-xl! py-2!">Sign Up</Button>
                        </Box>
                    </CardContent>
                </form>
                ...
                <CardActions>
                    <Box className="w-full flex justify-center items-center mb-4 gap-3">
                        ...
                        <Link to="/login" className="text-[#7D2D6F]! text-xl hover:underline!">Sign In</Link>
                    </Box>
                </CardActions>
            </Card>
        </Box>
